...
static SPACEMIT_CCU_PLL(pll2, "pll2", &pll2_rate_tbl,
	ARRAY_SIZE(pll2_rate_tbl),
	BASE_TYPE_APBS, APB_SPARE7_REG, APB_SPARE8_REG, APB_SPARE9_REG,
	MPMU_POSR, POSR_PLL2_LOCK, 1,
	CLK_IGNORE_UNUSED);

static SPACEMIT_CCU_PLL(pll3, "pll3", &pll3_rate_tbl,
	ARRAY_SIZE(pll3_rate_tbl),
...
static SPACEMIT_CCU_GATE_FACTOR(pll1_d11_223p4, "pll1_d11_223p4",
	"pll1_2457p6_vco",
	BASE_TYPE_APBS, APB_SPARE2_REG,
	BIT(15), BIT(15), 0x0,
	11, 1, CLK_IGNORE_UNUSED);

static SPACEMIT_CCU_GATE_FACTOR(pll1_d13_189, "pll1_d13_189",
	"pll1_2457p6_vco",
	BASE_TYPE_APBS, APB_SPARE2_REG,
	BIT(16), BIT(16), 0x0,
	13, 1, CLK_IGNORE_UNUSED);

static SPACEMIT_CCU_GATE_FACTOR(pll1_d23_106p8, "pll1_d23_106p8",
	"pll1_2457p6_vco",
	BASE_TYPE_APBS, APB_SPARE2_REG,
	BIT(20), BIT(20), 0x0,
	23, 1, CLK_IGNORE_UNUSED);

static SPACEMIT_CCU_GATE_FACTOR(pll1_d64_38p4, "pll1_d64_38p4",
	"pll1_2457p6_vco",
	BASE_TYPE_APBS, APB_SPARE2_REG,
	BIT(0), BIT(0), 0x0,
	64, 1, CLK_IGNORE_UNUSED);

static SPACEMIT_CCU_GATE_FACTOR(pll1_aud_245p7, "pll1_aud_245p7",
	"pll1_2457p6_vco",
	BASE_TYPE_APBS, APB_SPARE2_REG,
	BIT(10), BIT(10), 0x0,
	10, 1, CLK_IGNORE_UNUSED);

static SPACEMIT_CCU_GATE_FACTOR(pll1_aud_24p5, "pll1_aud_24p5",
	"pll1_2457p6_vco",
	BASE_TYPE_APBS, APB_SPARE2_REG,
	BIT(11), BIT(11), 0x0,
...
static SPACEMIT_CCU_FACTOR(pll1_d32_76p8,
	"pll1_d32_76p8", "pll1_d8_307p2",
	4, 1);

static SPACEMIT_CCU_FACTOR(pll1_d40_61p44,
	"pll1_d40_61p44", "pll1_d8_307p2",
	5, 1);

static SPACEMIT_CCU_FACTOR(pll1_d16_153p6,
	"pll1_d16_153p6", "pll1_d8",
	2, 1);

static SPACEMIT_CCU_GATE_FACTOR(pll1_d24_102p4,
	"pll1_d24_102p4", "pll1_d8",
	BASE_TYPE_MPMU, MPMU_ACGR,
	BIT(12), BIT(12), 0x0,
	3, 1, CLK_IGNORE_UNUSED);

static SPACEMIT_CCU_GATE_FACTOR(pll1_d48_51p2,
	"pll1_d48_51p2", "pll1_d8",
	BASE_TYPE_MPMU, MPMU_ACGR,
	BIT(7), BIT(7), 0x0,
	6, 1, CLK_IGNORE_UNUSED);

static SPACEMIT_CCU_GATE_FACTOR(pll1_d48_51p2_ap,
	"pll1_d48_51p2_ap", "pll1_d8",
	BASE_TYPE_MPMU, MPMU_ACGR,
	BIT(11), BIT(11), 0x0,
	6, 1, CLK_IGNORE_UNUSED);

static SPACEMIT_CCU_GATE_FACTOR(pll1_m3d128_57p6,
	"pll1_m3d128_57p6", "pll1_d8",
	BASE_TYPE_MPMU, MPMU_ACGR,
	BIT(8), BIT(8), 0x0,
	16, 3, CLK_IGNORE_UNUSED);

static SPACEMIT_CCU_GATE_FACTOR(pll1_d96_25p6,
	"pll1_d96_25p6", "pll1_d8",
	BASE_TYPE_MPMU, MPMU_ACGR,
	BIT(4), BIT(4), 0x0,
	12, 1, CLK_IGNORE_UNUSED);

static SPACEMIT_CCU_GATE_FACTOR(pll1_d192_12p8,
	"pll1_d192_12p8", "pll1_d8",
	BASE_TYPE_MPMU, MPMU_ACGR,
	BIT(3), BIT(3), 0x0,
	24, 1, CLK_IGNORE_UNUSED);

static SPACEMIT_CCU_GATE_FACTOR(pll1_d192_12p8_wdt,
	"pll1_d192_12p8_wdt",
	"pll1_d8",
	BASE_TYPE_MPMU, MPMU_ACGR,
	BIT(19), BIT(19), 0x0,
...
static SPACEMIT_CCU_GATE_FACTOR(pll1_d384_6p4,
	"pll1_d384_6p4", "pll1_d8",
	BASE_TYPE_MPMU, MPMU_ACGR,
	BIT(2), BIT(2), 0x0,
	48, 1, CLK_IGNORE_UNUSED);

static SPACEMIT_CCU_FACTOR(pll1_d768_3p2,
	"pll1_d768_3p2", "pll1_d384_6p4",
	2, 1);

static SPACEMIT_CCU_FACTOR(pll1_d1536_1p6,
	"pll1_d1536_1p6", "pll1_d384_6p4",
	4, 1);

static SPACEMIT_CCU_FACTOR(pll1_d3072_0p8,
	"pll1_d3072_0p8", "pll1_d384_6p4",
	8, 1);

//pll1_d7
static SPACEMIT_CCU_FACTOR(pll1_d7_351p08,
	"pll1_d7_351p08", "pll1_d7",
	1, 1);

//pll1_d6
static SPACEMIT_CCU_GATE(pll1_d6_409p6,
	"pll1_d6_409p6", "pll1_d6",
	BASE_TYPE_MPMU, MPMU_ACGR,
	BIT(0), BIT(0), 0x0,
	CLK_IGNORE_UNUSED);

static SPACEMIT_CCU_GATE_FACTOR(pll1_d12_204p8,
	"pll1_d12_204p8", "pll1_d6",
	BASE_TYPE_MPMU, MPMU_ACGR,
	BIT(5), BIT(5), 0x0,
	2, 1, CLK_IGNORE_UNUSED);

//pll1_d5
static SPACEMIT_CCU_GATE(pll1_d5_491p52,
	"pll1_d5_491p52", "pll1_d5",
	BASE_TYPE_MPMU, MPMU_ACGR,
	BIT(21), BIT(21), 0x0,
	CLK_IGNORE_UNUSED);

static SPACEMIT_CCU_GATE_FACTOR(pll1_d10_245p76,
	"pll1_d10_245p76", "pll1_d5",
	BASE_TYPE_MPMU, MPMU_ACGR,
	BIT(18), BIT(18), 0x0,
	2, 1, CLK_IGNORE_UNUSED);

//pll1_d4
static SPACEMIT_CCU_GATE(pll1_d4_614p4,
	"pll1_d4_614p4", "pll1_d4",
	BASE_TYPE_MPMU, MPMU_ACGR,
	BIT(15), BIT(15), 0x0,
	CLK_IGNORE_UNUSED);

static SPACEMIT_CCU_GATE_FACTOR(pll1_d52_47p26,
	"pll1_d52_47p26", "pll1_d4",
	BASE_TYPE_MPMU, MPMU_ACGR,
	BIT(10), BIT(10), 0x0,
	13, 1, CLK_IGNORE_UNUSED);

static SPACEMIT_CCU_GATE_FACTOR(pll1_d78_31p5,
...
//pll1_d3
static SPACEMIT_CCU_GATE(pll1_d3_819p2,
	"pll1_d3_819p2", "pll1_d3",
	BASE_TYPE_MPMU, MPMU_ACGR,
	BIT(14), BIT(14), 0x0,
	CLK_IGNORE_UNUSED);

//pll1_d2
static SPACEMIT_CCU_GATE(pll1_d2_1228p8,
	"pll1_d2_1228p8", "pll1_d2",
	BASE_TYPE_MPMU, MPMU_ACGR,
	BIT(16), BIT(16), 0x0,
	CLK_IGNORE_UNUSED);
...
static const struct ccu_dpll_rate_tbl dpll1_rate_tbl[] = {
	DPLL_RATE(2400000000UL, 0x00, 0x00, 0x20,
		  0x2a, 0x32, 0x64, 0xdd, 0x50),
	DPLL_RATE(2400000000UL, 0x00, 0x3b, 0x20,
		  0x2a, 0x32, 0x64, 0xdd, 0x50),
};

static const struct ccu_dpll_rate_tbl dpll2_rate_tbl[] = {
	DPLL_RATE(3200000000UL, 0x55, 0x55, 0x3d,
		  0x2a, 0x43, 0x67, 0xdd, 0x50),
};

static SPACEMIT_CCU_DPLL(dpll1, "dpll1", &dpll1_rate_tbl,
	ARRAY_SIZE(dpll1_rate_tbl),
	BASE_TYPE_APMU, APMU_DPLL1_CLK_CTRL1, APMU_DPLL1_CLK_CTRL2,
	0, CLK_IGNORE_UNUSED);

static SPACEMIT_CCU_DPLL(dpll2, "dpll2", &dpll2_rate_tbl,
	ARRAY_SIZE(dpll2_rate_tbl),
...
static SPACEMIT_CCU_DIV_MUX(dfc_lvl0, "dfc_lvl0",
	dfc_lvl_parents, BASE_TYPE_APMU, APMU_DFC_LEVEL0,
	14, 2, 8, 1, 0);

static SPACEMIT_CCU_DIV_MUX(dfc_lvl1, "dfc_lvl1",
	dfc_lvl_parents, BASE_TYPE_APMU, APMU_DFC_LEVEL1,
	14, 2, 8, 1, 0);

static SPACEMIT_CCU_DIV_MUX(dfc_lvl2, "dfc_lvl2",
	dfc_lvl_parents, BASE_TYPE_APMU, APMU_DFC_LEVEL2,
	14, 2, 8, 1, 0);

static SPACEMIT_CCU_DIV_MUX(dfc_lvl3, "dfc_lvl3",
	dfc_lvl_parents, BASE_TYPE_APMU, APMU_DFC_LEVEL3,
	14, 2, 8, 1, 0);

static SPACEMIT_CCU_DIV_MUX(dfc_lvl4, "dfc_lvl4",
	dfc_lvl_parents, BASE_TYPE_APMU, APMU_DFC_LEVEL4,
	14, 2, 8, 1, 0);

static SPACEMIT_CCU_DIV_MUX(dfc_lvl5, "dfc_lvl5",
	dfc_lvl_parents, BASE_TYPE_APMU, APMU_DFC_LEVEL5,
	14, 2, 8, 1, 0);

static SPACEMIT_CCU_DIV_MUX(dfc_lvl6, "dfc_lvl6",
	dfc_lvl_parents, BASE_TYPE_APMU, APMU_DFC_LEVEL6,
	14, 2, 8, 1, 0);

static SPACEMIT_CCU_DIV_MUX(dfc_lvl7, "dfc_lvl7",
	dfc_lvl_parents, BASE_TYPE_APMU, APMU_DFC_LEVEL7,
	14, 2, 8, 1, 0);

static const char * const ddr_clk_parents[] = {
	"dfc_lvl0", "dfc_lvl1", "dfc_lvl2", "dfc_lvl3",
	"dfc_lvl4", "dfc_lvl5", "dfc_lvl6", "dfc_lvl7"
};
...
static SPACEMIT_CCU_GATE_NO_PARENT(slow_uart,
	"slow_uart", NULL,
	BASE_TYPE_MPMU, MPMU_ACGR,
	BIT(1), BIT(1), 0x0,
	0);

static SPACEMIT_CCU_DDN(slow_uart1_14p74,
	"slow_uart1_14p74", "pll1_d16_153p6",
	&uart_ddn_mask_info, &slow_uart1_tbl,
	ARRAY_SIZE(slow_uart1_tbl),
	BASE_TYPE_MPMU, MPMU_SUCCR,
	CLK_IGNORE_UNUSED);

static SPACEMIT_CCU_DDN(slow_uart2_48,
	"slow_uart2_48", "pll1_d4_614p4",
	&uart_ddn_mask_info, &slow_uart2_tbl,
	ARRAY_SIZE(slow_uart2_tbl),
...
static SPACEMIT_CCU_MUX_GATE(uart1_clk, "uart1_clk",
	uart_parent_names, BASE_TYPE_APBC, APBC_UART1_CLK_RST,
	4, 3, 0x3, 0x3, 0x0,
	0);

static SPACEMIT_CCU_MUX_GATE(uart2_clk, "uart2_clk",
	uart_parent_names, BASE_TYPE_APBC, APBC_UART2_CLK_RST,
	4, 3, 0x3, 0x3, 0x0,
	0);

static SPACEMIT_CCU_MUX_GATE(uart3_clk, "uart3_clk",
	uart_parent_names, BASE_TYPE_APBC, APBC_UART3_CLK_RST,
	4, 3, 0x3, 0x3, 0x0,
	0);

static SPACEMIT_CCU_MUX_GATE(uart4_clk, "uart4_clk",
	uart_parent_names, BASE_TYPE_APBC, APBC_UART4_CLK_RST,
	4, 3, 0x3, 0x3, 0x0,
	0);

static SPACEMIT_CCU_MUX_GATE(uart5_clk, "uart5_clk",
	uart_parent_names, BASE_TYPE_APBC, APBC_UART5_CLK_RST,
	4, 3, 0x3, 0x3, 0x0,
	0);

static SPACEMIT_CCU_MUX_GATE(uart6_clk, "uart6_clk",
	uart_parent_names, BASE_TYPE_APBC, APBC_UART6_CLK_RST,
	4, 3, 0x3, 0x3, 0x0,
	0);

static SPACEMIT_CCU_MUX_GATE(uart7_clk, "uart7_clk",
	uart_parent_names, BASE_TYPE_APBC, APBC_UART7_CLK_RST,
	4, 3, 0x3, 0x3, 0x0,
	0);

static SPACEMIT_CCU_MUX_GATE(uart8_clk, "uart8_clk",
	uart_parent_names, BASE_TYPE_APBC, APBC_UART8_CLK_RST,
	4, 3, 0x3, 0x3, 0x0,
	0);

static SPACEMIT_CCU_MUX_GATE(uart9_clk, "uart9_clk",
	uart_parent_names, BASE_TYPE_APBC, APBC_UART9_CLK_RST,
	4, 3, 0x3, 0x3, 0x0,
	0);
...
static SPACEMIT_CCU_MUX_GATE(pwm0_clk, "pwm0_clk",
	pwm_parent_names, BASE_TYPE_APBC, APBC_PWM0_CLK_RST,
	4, 3, 0x2, 0x2, 0x0,
	0);

static SPACEMIT_CCU_MUX_GATE(pwm1_clk, "pwm1_clk",
	pwm_parent_names, BASE_TYPE_APBC, APBC_PWM1_CLK_RST,
	4, 3, 0x2, 0x2, 0x0,
	0);

static SPACEMIT_CCU_MUX_GATE(pwm2_clk, "pwm2_clk",
	pwm_parent_names, BASE_TYPE_APBC, APBC_PWM2_CLK_RST,
	4, 3, 0x2, 0x2, 0x0,
	0);

static SPACEMIT_CCU_MUX_GATE(pwm3_clk, "pwm3_clk",
	pwm_parent_names, BASE_TYPE_APBC, APBC_PWM3_CLK_RST,
	4, 3, 0x2, 0x2, 0x0,
	0);

static SPACEMIT_CCU_MUX_GATE(pwm4_clk, "pwm4_clk",
	pwm_parent_names, BASE_TYPE_APBC, APBC_PWM4_CLK_RST,
	4, 3, 0x2, 0x2, 0x0,
	0);

static SPACEMIT_CCU_MUX_GATE(pwm5_clk, "pwm5_clk",
	pwm_parent_names, BASE_TYPE_APBC, APBC_PWM5_CLK_RST,
	4, 3, 0x2, 0x2, 0x0,
	0);

static SPACEMIT_CCU_MUX_GATE(pwm6_clk, "pwm6_clk",
	pwm_parent_names, BASE_TYPE_APBC, APBC_PWM6_CLK_RST,
	4, 3, 0x2, 0x2, 0x0,
	0);

static SPACEMIT_CCU_MUX_GATE(pwm7_clk, "pwm7_clk",
	pwm_parent_names, BASE_TYPE_APBC, APBC_PWM7_CLK_RST,
	4, 3, 0x2, 0x2, 0x0,
	0);

static SPACEMIT_CCU_MUX_GATE(pwm8_clk, "pwm8_clk",
	pwm_parent_names, BASE_TYPE_APBC, APBC_PWM8_CLK_RST,
	4, 3, 0x2, 0x2, 0x0,
	0);

static SPACEMIT_CCU_MUX_GATE(pwm9_clk, "pwm9_clk",
	pwm_parent_names, BASE_TYPE_APBC, APBC_PWM9_CLK_RST,
	4, 3, 0x2, 0x2, 0x0,
	0);

static SPACEMIT_CCU_MUX_GATE(pwm10_clk, "pwm10_clk",
	pwm_parent_names, BASE_TYPE_APBC, APBC_PWM10_CLK_RST,
	4, 3, 0x2, 0x2, 0x0,
	0);

static SPACEMIT_CCU_MUX_GATE(pwm11_clk, "pwm11_clk",
	pwm_parent_names, BASE_TYPE_APBC, APBC_PWM11_CLK_RST,
	4, 3, 0x2, 0x2, 0x0,
	0);

static SPACEMIT_CCU_MUX_GATE(pwm12_clk, "pwm12_clk",
	pwm_parent_names, BASE_TYPE_APBC, APBC_PWM12_CLK_RST,
	4, 3, 0x2, 0x2, 0x0,
	0);

static SPACEMIT_CCU_MUX_GATE(pwm13_clk, "pwm13_clk",
	pwm_parent_names, BASE_TYPE_APBC, APBC_PWM13_CLK_RST,
	4, 3, 0x2, 0x2, 0x0,
	0);

static SPACEMIT_CCU_MUX_GATE(pwm14_clk, "pwm14_clk",
	pwm_parent_names, BASE_TYPE_APBC, APBC_PWM14_CLK_RST,
	4, 3, 0x2, 0x2, 0x0,
	0);

static SPACEMIT_CCU_MUX_GATE(pwm15_clk, "pwm15_clk",
	pwm_parent_names, BASE_TYPE_APBC, APBC_PWM15_CLK_RST,
	4, 3, 0x2, 0x2, 0x0,
	0);

static SPACEMIT_CCU_MUX_GATE(pwm16_clk, "pwm16_clk",
	pwm_parent_names, BASE_TYPE_APBC, APBC_PWM16_CLK_RST,
	4, 3, 0x2, 0x2, 0x0,
	0);

static SPACEMIT_CCU_MUX_GATE(pwm17_clk, "pwm17_clk",
	pwm_parent_names, BASE_TYPE_APBC, APBC_PWM17_CLK_RST,
	4, 3, 0x2, 0x2, 0x0,
	0);

static SPACEMIT_CCU_MUX_GATE(pwm18_clk, "pwm18_clk",
	pwm_parent_names, BASE_TYPE_APBC, APBC_PWM18_CLK_RST,
	4, 3, 0x2, 0x2, 0x0,
	0);

static SPACEMIT_CCU_MUX_GATE(pwm19_clk, "pwm19_clk",
	pwm_parent_names, BASE_TYPE_APBC, APBC_PWM19_CLK_RST,
	4, 3, 0x2, 0x2, 0x0,
	0);

static const char * const ssp_parent_names[] = {
	"pll1_d384_6p4", "pll1_d192_12p8", "pll1_d96_25p6",
	"pll1_d48_51p2", "pll1_d768_3p2", "pll1_d1536_1p6",
	"pll1_d3072_0p8"
};

static SPACEMIT_CCU_MUX_GATE(ssp3_clk,
	"ssp3_clk", ssp_parent_names,
...
static SPACEMIT_CCU_MUX_GATE(twsi0_clk, "twsi0_clk",
	twsi_parent_names, BASE_TYPE_APBC, APBC_TWSI0_CLK_RST,
	4, 3, 0x3, 0x3, 0x0,
	0);

static SPACEMIT_CCU_MUX_GATE(twsi1_clk, "twsi1_clk",
	twsi_parent_names, BASE_TYPE_APBC, APBC_TWSI1_CLK_RST,
	4, 3, 0x3, 0x3, 0x0,
	0);

static SPACEMIT_CCU_MUX_GATE(twsi2_clk, "twsi2_clk",
	twsi_parent_names, BASE_TYPE_APBC, APBC_TWSI2_CLK_RST,
	4, 3, 0x3, 0x3, 0x0,
	0);

static SPACEMIT_CCU_MUX_GATE(twsi4_clk, "twsi4_clk",
	twsi_parent_names, BASE_TYPE_APBC, APBC_TWSI4_CLK_RST,
	4, 3, 0x3, 0x3, 0x0,
	0);

static SPACEMIT_CCU_MUX_GATE(twsi5_clk, "twsi5_clk",
	twsi_parent_names, BASE_TYPE_APBC, APBC_TWSI5_CLK_RST,
	4, 3, 0x3, 0x3, 0x0,
	0);

static SPACEMIT_CCU_MUX_GATE(twsi6_clk, "twsi6_clk",
	twsi_parent_names, BASE_TYPE_APBC, APBC_TWSI6_CLK_RST,
	4, 3, 0x3, 0x3, 0x0,
	0);

static SPACEMIT_CCU_MUX_GATE(twsi7_clk, "twsi7_clk",
	twsi_parent_names, BASE_TYPE_APBC, APBC_TWSI7_CLK_RST,
	4, 3, 0x3, 0x3, 0x0,
	0);

static SPACEMIT_CCU_MUX_GATE(twsi8_clk, "twsi8_clk",
	twsi_parent_names, BASE_TYPE_APBC, APBC_TWSI8_CLK_RST,
	4, 3, 0x7, 0x3, 0x4,
	0);
...
static SPACEMIT_CCU_MUX_GATE(timers1_clk, "timers1_clk",
	timer_parent_names, BASE_TYPE_APBC, APBC_TIMERS1_CLK_RST,
	4, 3, 0x3, 0x3, 0x0,
	0);

static SPACEMIT_CCU_MUX_GATE(timers2_clk,
	"timers2_clk", timer_parent_names,
...
static SPACEMIT_CCU_GATE_NO_PARENT(onewire_clk,
	"onewire_clk", NULL,
	BASE_TYPE_APBC, APBC_ONEWIRE_CLK_RST,
	0x3, 0x3, 0x0, 0);

static SPACEMIT_CCU_GATE_FACTOR(i2s_sysclk,
	"i2s_sysclk", "pll1_d8_307p2",
	BASE_TYPE_MPMU, MPMU_ISCCR,
	BIT(31), BIT(31), 0x0,
	200, 1, 0);

static SPACEMIT_CCU_GATE_FACTOR(i2s_bclk,
	"i2s_bclk", "i2s_sysclk",
	BASE_TYPE_MPMU, MPMU_ISCCR,
	BIT(29), BIT(29), 0x0,
	1, 1, 0);
...
static SPACEMIT_CCU_GATE_NO_PARENT(ipc_ap2aud_clk, "ipc_ap2aud_clk",
	NULL, BASE_TYPE_APBC, APBC_IPC_AP2AUD_CLK_RST,
	0x3, 0x3, 0x0, 0);
...
static const char * const jpg_parent_names[] = {
	"pll1_d4_614p4", "pll1_d6_409p6", "pll1_d5_491p52",
	"pll1_d3_819p2", "pll1_d2_1228p8", "pll2_d4", "pll2_d3"
};

static SPACEMIT_CCU_DIV_FC_MUX_GATE(jpg_clk, "jpg_clk",
	jpg_parent_names, BASE_TYPE_APMU, APMU_JPG_CLK_RES_CTRL,
	5, 3, BIT(15),
	2, 3, BIT(1), BIT(1), 0x0,
	0);

static SPACEMIT_CCU_GATE_NO_PARENT(jpg_4kafbc_clk, "jpg_4kafbc_clk",
	NULL, BASE_TYPE_APMU, APMU_JPG_CLK_RES_CTRL,
	BIT(16), BIT(16), 0x0, 0);

static SPACEMIT_CCU_GATE_NO_PARENT(jpg_2kafbc_clk, "jpg_2kafbc_clk",
	NULL, BASE_TYPE_APMU, APMU_JPG_CLK_RES_CTRL,
	BIT(17), BIT(17), 0x0, 0);
...
static SPACEMIT_CCU_MUX_GATE(ccic2phy_clk, "ccic2phy_clk",
	ccic2phy_parent_names,
...
static SPACEMIT_CCU_MUX_GATE(ccic3phy_clk, "ccic3phy_clk",
	ccic3phy_parent_names,
	BASE_TYPE_APMU, APMU_CSI_CCIC2_CLK_RES_CTRL,
	31, 1, BIT(30), BIT(30), 0x0, 0);

static const char * const csi_parent_names[] = {
	"pll1_d5_491p52", "pll1_d6_409p6", "pll1_d4_614p4",
	"pll1_d3_819p2", "pll2_d2", "pll2_d3", "pll2_d4",
	"pll1_d2_1228p8"
};

static SPACEMIT_CCU_DIV_FC_MUX_GATE(csi_clk, "csi_clk",
	csi_parent_names, BASE_TYPE_APMU, APMU_CSI_CCIC2_CLK_RES_CTRL,
	20, 3, BIT(15),
...
static SPACEMIT_CCU_DIV_MUX_GATE(camm0_clk, "camm0_clk",
	camm_parent_names, BASE_TYPE_APMU, APMU_CSI_CCIC2_CLK_RES_CTRL,
	23, 4, 8, 2,
	BIT(28), BIT(28), 0x0,
	0);

static SPACEMIT_CCU_DIV_MUX_GATE(camm1_clk, "camm1_clk",
	camm_parent_names, BASE_TYPE_APMU, APMU_CSI_CCIC2_CLK_RES_CTRL,
	23, 4, 8, 2,
	BIT(6), BIT(6), 0x0,
	0);

static SPACEMIT_CCU_DIV_MUX_GATE(camm2_clk, "camm2_clk",
	camm_parent_names, BASE_TYPE_APMU, APMU_CSI_CCIC2_CLK_RES_CTRL,
	23, 4, 8, 2,
	BIT(3), BIT(3), 0x0,
	0);
...
static SPACEMIT_CCU_DIV_MUX_GATE(isp_cpp_clk, "isp_cpp_clk",
	isp_cpp_parent_names,
...
static const char * const isp_bus_parent_names[] = {
	"pll1_d6_409p6", "pll1_d5_491p52", "pll1_d8_307p2",
	"pll1_d10_245p76"
};

static SPACEMIT_CCU_DIV_FC_MUX_GATE(isp_bus_clk, "isp_bus_clk",
...
static const char * const isp_parent_names[] = {
	"pll1_d6_409p6", "pll1_d5_491p52", "pll1_d4_614p4",
	"pll1_d8_307p2"
};

static SPACEMIT_CCU_DIV_FC_MUX_GATE(isp_clk, "isp_clk",
	isp_parent_names, BASE_TYPE_APMU, APMU_ISP_CLK_RES_CTRL,
	4, 3, BIT(7),
	8, 2, BIT(1), BIT(1), 0x0,
	0);
...
static SPACEMIT_CCU_DIV2_FC_MUX_GATE(dpu_mclk, "dpu_mclk",
	dpumclk_parent_names, BASE_TYPE_APMU,
	APMU_LCD_CLK_RES_CTRL1, APMU_LCD_CLK_RES_CTRL2,
	1, 4, BIT(29),
	5, 3, BIT(0), BIT(0), 0x0,
	0);

static const char * const dpuesc_parent_names[] = {
	"pll1_d48_51p2_ap", "pll1_d52_47p26", "pll1_d96_25p6",
	"pll1_d32_76p8"
};
...
static const char * const dpubit_parent_names[] = {
	"pll1_d3_819p2", "pll2_d2", "pll2_d3", "pll1_d2_1228p8",
	"pll2_d4", "pll2_d5", "pll2_d8", "pll2_d8"
};

static SPACEMIT_CCU_DIV_FC_MUX_GATE(dpu_bit_clk, "dpu_bit_clk",
	dpubit_parent_names,
	BASE_TYPE_APMU, APMU_LCD_CLK_RES_CTRL1,
	17, 3, BIT(31),
...
static const char * const dpu_spi_parent_names[] = {
	"pll1_d8_307p2", "pll1_d6_409p6", "pll1_d10_245p76",
	"pll1_d11_223p4", "pll1_d13_189", "pll1_d23_106p8",
	"pll2_d3", "pll2_d5"
};

static SPACEMIT_CCU_DIV_FC_MUX_GATE(dpu_spi_clk, "dpu_spi_clk",
...
static const char * const v2d_parent_names[] = {
	"pll1_d5_491p52", "pll1_d6_409p6", "pll1_d8_307p2",
	"pll1_d4_614p4",
};
...
static SPACEMIT_CCU_DIV_FC_MUX_GATE(ccic_4x_clk, "ccic_4x_clk",
...
static SPACEMIT_CCU_MUX_GATE(ccic1phy_clk, "ccic1phy_clk",
	ccic1phy_parent_names,
	BASE_TYPE_APMU, APMU_CCIC_CLK_RES_CTRL,
	7, 1, BIT(5), BIT(5), 0x0,
	0);
...
static const char * const sdh2_parent_names[] = {
	"pll1_d6_409p6", "pll1_d4_614p4", "pll2_d8",
	"pll1_d3_819p2", "pll1_d11_223p4", "pll1_d13_189",
	"pll1_d23_106p8"
};
...
static const char * const qspi_parent_names[] = {
	"pll1_d6_409p6", "pll2_d8", "pll1_d8_307p2",
	"pll1_d10_245p76", "pll1_d11_223p4", "pll1_d23_106p8",
	"pll1_d5_491p52", "pll1_d13_189"
};
...
static const char * const vpu_parent_names[] = {
	"pll1_d4_614p4", "pll1_d5_491p52", "pll1_d3_819p2",
	"pll1_d6_409p6", "pll3_d6", "pll2_d3", "pll2_d4", "pll2_d5"
};
...
static const char * const cpu_c0_parent_names[] = {
	...
	"pll1_d5_491p52", "pll1_d2_1228p8", "pll3_d3",
	"pll2_d3", "cpu_c0_hi_clk"
};

static SPACEMIT_CCU_MUX_FC(cpu_c0_core_clk, "cpu_c0_core_clk",
	cpu_c0_parent_names,
	BASE_TYPE_APMU, APMU_CPU_C0_CLK_CTRL,
	BIT(12),
	0, 3,
...
static SPACEMIT_CCU_MUX_GATE(uart1_sec_clk, "uart1_sec_clk",
	uart1_sec_parent_names,
	BASE_TYPE_APBC2, APBC2_UART1_CLK_RST,
	4, 3, 0x3, 0x3, 0x0,
	0);

static const char * const ssp2_sec_parent_names[] = {
	"pll1_d384_6p4", "pll1_d192_12p8", "pll1_d96_25p6",
	"pll1_d48_51p2", "pll1_d768_3p2", "pll1_d1536_1p6",
	"pll1_d3072_0p8"
};

static SPACEMIT_CCU_MUX_GATE(ssp2_sec_clk, "ssp2_sec_clk",
	ssp2_sec_parent_names,
	BASE_TYPE_APBC2, APBC2_SSP2_CLK_RST,
	4, 3, 0x3, 0x3, 0x0,
	0);

static const char * const twsi3_sec_parent_names[] = {
	"pll1_d78_31p5", "pll1_d48_51p2", "pll1_d40_61p44"
};

static SPACEMIT_CCU_MUX_GATE(twsi3_sec_clk, "twsi3_sec_clk",
	twsi3_sec_parent_names,
...
static const char * const timer_sec_parent_names[] = {
	"pll1_d192_12p8", "clk_32k", "pll1_d384_6p4", "vctcxo_3", "vctcxo_1"
};

static SPACEMIT_CCU_MUX_GATE(timers0_sec_clk, "timers0_sec_clk",
	timer_sec_parent_names,
	BASE_TYPE_APBC2, APBC2_TIMERS0_CLK_RST,
	4, 3, 0x3, 0x3, 0x0,
	0);

static const char * const kpc_sec_parent_names[] = {
	"pll1_d192_12p8", "clk_32k", "pll1_d384_6p4", "vctcxo_3", "vctcxo_1"
};
...
static SPACEMIT_CCU_MUX(apb_clk, "apb_clk", apb_parent_names,
	...
	0, 2, 0);
//rcpu
static const char * const rhdmi_audio_parent_names[] = {
	"pll1_aud_24p5", "pll1_aud_245p7"
};

static SPACEMIT_CCU_DIV_MUX_GATE(rhdmi_audio_clk, "rhdmi_audio_clk",
	rhdmi_audio_parent_names,
	BASE_TYPE_RCPU, RCPU_HDMI_CLK_RST,
	4, 11, 16, 2,
	0x6, 0x6, 0x0,
	0);

static const char * const rcan_parent_names[] = {
	"pll3_20", "pll3_40", "pll3_80"
};
...
static const char * const rpwm_parent_names[] = {
...
static const char * const ri2c_parent_names[] = {
...
static const char * const rssp0_parent_names[] = {
	"pll1_d40_61p44", "pll1_d96_25p6", "pll1_d192_12p8", "vctcxo_3"
};
...
static const char * const ruart0_parent_names[] = {
...
static const char * const ruart1_parent_names[] = {
	"pll1_aud_24p5", "pll1_aud_245p7", "vctcxo_24", "vctcxo_3"
};
		       ...
		       struct clk_hw_onecell_data *hw_clks)
{
	...
	ret = of_clk_add_hw_provider(node, of_clk_hw_onecell_get, hw_clks);
	if (ret)
		goto err_clk_unreg;

	spacemit_clocks_enable(bootup_enable_clk_table,
			       ARRAY_SIZE(bootup_enable_clk_table));
